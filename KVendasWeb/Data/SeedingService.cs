...
namespace KVendasWeb.Data
{
    ...
    {
        private KVendasWebContext _context;

        public SeedingService(KVendasWebContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Departament d2 = new Departament { Id = 2, Name = "Moda" };
            Departament d3 = new Departament { Id = 3, Name = "Livros" };
            Departament d4 = new Departament { Id = 4, Name = "Instrumentos" };
